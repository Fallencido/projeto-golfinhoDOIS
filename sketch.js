...
function preload(){
  aguaImg = loadImage("underwater.jpg");
  doorImg = loadImage("door.png");
  climberImg = loadImage("bolinha.png");
  golfinhoImg = loadImage("golfinho_frontal.png");
...
function setup() {
  ...
  ghost.scale = 0.3;
  ghost.addImage("ghost", golfinhoImg);
  ghost.scale = 0.08;
}
